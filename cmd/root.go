...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.goshot.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".goshot" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".goshot")
	}
